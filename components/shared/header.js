  ...
  return (
    ...
    >
      <div className="h-24 px-4 lg:px-12 flex justify-between items-center ">
        ...
        <div>
          <div className="hidden lg:flex lg:items-center lg:justify-center lg:gap-9">
            ...
            <button className="relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium rounded-lg group bg-gradient-to-br from-[#395cf3] to-[#ff2d95] text-white focus:ring-4 focus:outline-none focus:ring-transparent">
              <span
      ...
      >
        ...
        <button className="relative inline-flex items-center w-full justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium rounded-lg group bg-gradient-to-br from-[#395cf3] to-[#ff2d95] text-white focus:ring-4 focus:outline-none focus:ring-transparent">
          <span
